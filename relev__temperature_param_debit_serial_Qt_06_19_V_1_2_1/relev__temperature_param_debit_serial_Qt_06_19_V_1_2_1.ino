/*
   ...
   @version : V_1_2_1
   @description :
   Redéfinition des fonctions & interruption de gestion du chrono prescence pellet.
...
#ifdef COMMENT
  Serial << "via MAJ FLAG" << endl;
#endif
    chronoPellets += (endPellets - beginningPellets);
    majChrono = false;
#ifdef COMMENT
  Serial << " FLAG maj = " << majChrono << endl;
#endif
